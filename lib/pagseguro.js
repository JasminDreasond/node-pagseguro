...
(function () {
  ...
  pagseguro = (function () {
    ...
    pagseguro.prototype.send = function (callback) {
      ...
      switch (this.mode) {
        case 'payment':
          options.uri = this.uri + "/checkout?email=" + this.email + "&token=" + this.token;
          options.body = this.xml + xml.toXML({
            checkout: this.obj
          });
          break;
        case 'subscription':
          options.uri = this.uri + "/pre-approvals/request?email=" + this.email + "&token=" + this.token;
          options.body = this.xml + xml.toXML({
    ...
    pagseguro.prototype.getTransaction = function (code, callback) {
    ...
    pagseguro.prototype.getNotification = function (code, callback) {
